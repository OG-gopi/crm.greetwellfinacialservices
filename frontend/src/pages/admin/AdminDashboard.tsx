...
import { CardSkeleton, ChartSkeleton, TableSkeleton, ListSkeleton } from '../../components/common/Skeletons';
        ...
        {loading ? (
          ...
          <>
            ...
            <Link to="/superadmin/agents/manage" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              ...
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Total Advisors</p>
                <h3 className="text-xl font-black text-slate-900 mt-0.5">{metrics?.totalAgents || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Domain specialists</p>
              </div>
            </Link>
            ...
            <Link to="/superadmin/applications/all" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded">All Services</span>
              </div>
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Total Apps</p>
                <h3 className="text-xl font-black text-slate-900 mt-0.5">{metrics?.totalApplications || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Submitted pipeline</p>
              </div>
            </Link>

            {/* Card 4: Loan Apps */}
            <Link to="/superadmin/applications/loans" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">Loans</span>
              </div>
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Loan Apps</p>
                <h3 className="text-xl font-black text-slate-900 mt-0.5">{metrics?.loanApplications || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Personal, Home, Business</p>
              </div>
            </Link>

            {/* Card 5: Insurance Apps */}
            <Link to="/superadmin/applications/insurance" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-violet-600 bg-violet-50 px-1.5 py-0.5 rounded">Insurance</span>
              </div>
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Insurance Apps</p>
                <h3 className="text-xl font-black text-slate-900 mt-0.5">{metrics?.insuranceApplications || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Health, Life, Motor</p>
              </div>
            </Link>

            {/* Card 6: Investment Apps */}
            <Link to="/superadmin/applications/investments" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                <div className="p-2 rounded-xl bg-emerald-50 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  <TrendingUp className="h-4 w-4" />
                </div>
                <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">Investments</span>
              </div>
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Investment Apps</p>
                <h3 className="text-xl font-black text-slate-900 mt-0.5">{metrics?.investmentApplications || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Mutual Funds, SIPs, Bonds</p>
              </div>
            </Link>

            {/* Card 7: Pending Verification */}
            <Link to="/superadmin/users/verification" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Pending KYC/Users</p>
                <h3 className="text-xl font-black text-amber-600 mt-0.5">{metrics?.pendingVerifications || 0}</h3>
                <p className="text-[10px] text-slate-500 mt-1">Verification queue</p>
              </div>
            </Link>

            {/* Card 8: Pending Applications */}
            <Link to="/superadmin/applications/all" className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all group">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-orange-600 bg-orange-50 px-1.5 py-0.5 rounded">In Review</span>
              </div>
              <div className="mt-2.5">
                <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">Pending Processing</p>
                <h3 className="text-xl font-black text-orange-600 mt-0.5">{metrics?.pendingApplications || 0}</h3>
          ...
          <>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b pb-3">
                <div>
                  <h3 className="font-extrabold text-slate-900 text-sm">Recent Submitted Applications</h3>
                  <p className="text-[11px] text-slate-500">Latest active requests needing attention</p>
                </div>
                      ...
                      filteredApplications.map((app: any) => (
                        <tr key={app.id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="py-3 px-3 text-right">
                            <Link
                              to={`/superadmin/applications?id=${app.id}`}
                              className="p-1.5 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors inline-block"
